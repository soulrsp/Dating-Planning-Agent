...
async function handleInAppMapSearch() {
    ...
    // 1. Real-time Naver Maps Dynamic Search API (Fastest & 100% Reliable Engine)
    try {
    ...
    if (isNaverMapActive && combinedResults.length === 0) {
        try {
    ...
    // 3. Naver Open Local Search API (Fast 800ms fallback)
